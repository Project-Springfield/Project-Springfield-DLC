...
void main()
{
    ...
    lDiffuseColour.rgb = (1.0 - vec4Param1.a) * lDiffuseColour.rgb;
    lDiffuseColour.rgb += vec4Param1.a * vec4Param1.rgb;
    lDiffuseColour = min(lDiffuseColour, vec4(1.0, 1.0, 1.0, 1.0));
